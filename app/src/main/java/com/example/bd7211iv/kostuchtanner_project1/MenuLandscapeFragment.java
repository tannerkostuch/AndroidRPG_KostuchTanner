 ...
 */
public class MenuLandscapeFragment extends Fragment {
    Player player;
    String[] playerInfo;
    ListView playerList;
    String[] monsterInfo;

    public MenuLandscapeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_menu_landscape, container, false);
    }
    @Override
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState){
        ...
        GridView monsterGrid= view.findViewById(R.id.monsterGrid);
